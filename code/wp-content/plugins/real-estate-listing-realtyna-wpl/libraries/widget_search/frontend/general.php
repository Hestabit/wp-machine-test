...
elseif(($type == 'price' or $type == 'mmprice') and !$done_this)
{
	...
	if($show == 'minmax')
	{
		...
		$html .= '<input name="sf'.$widget_id.'_min_'.$min_column.'" type="'.$input_type.'" id="sf'.$widget_id.'_min_'.$min_column.'" step="'.$division.'" min="'.$min_value.'" value="'.$current_min_value.'" placeholder="'.sprintf(__('Min %s', 'real-estate-listing-realtyna-wpl'), $field_data['name']).'" />';
		...
		$html .= '<input name="sf'.$widget_id.'_max_'.$max_column.'" type="'.$input_type.'" id="sf'.$widget_id.'_max_'.$max_column.'" step="'.$division.'" min="'.$min_value.'" value="'.$current_max_value.'" placeholder="'.sprintf(__('Max %s', 'real-estate-listing-realtyna-wpl'), $field_data['name']).'" />';
	}
	elseif($show == 'minmax_slider')
	{
