        ...
        wplj.ajax(
            {
                ...
                success: function (data) {
                    ...
                    mlsProviders += '<td class="wpl-idx-addon-table-title"><?php echo __('One-time Price','real-estate-listing-realtyna-wpl'); ?></td>';
                    mlsProviders += '</tr>';
                    wplj.each(data.message, function (key, value) {
                        mlsProviders += '<tr class="wpl-idx-addon-table-row">';
                        ...
                        mlsProviders += '<td class="price_one_time">'+ value.one_time_price +'$</td>';
                        mlsProviders += '</tr>';
                    });
                    Realtyna.ajaxLoader.hide(loader);
